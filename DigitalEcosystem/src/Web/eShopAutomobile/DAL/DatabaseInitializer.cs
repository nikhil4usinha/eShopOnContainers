    ...
    public class DatabaseInitializer : IDatabaseInitializer
    {
        ...
        public async Task SeedAsync()
        {
            ...
            if (!await _context.Users.AnyAsync())
            {
                ...
                await CreateUserAsync("admin", "Test$123", "Inbuilt Administrator", "admin@ey.com", "+1 (123) 000-0000", new string[] { adminRoleName });
                await CreateUserAsync("user", "Test$123", "Inbuilt Standard User", "user@ey.com", "+1 (123) 000-0001", new string[] { userRoleName });

                await CreateUserAsync("customer", "Test$123", " Automotive Customer", "customer@ey.com", "+1 (123) 000-0001", new string[] { customerRoleName });
                await CreateUserAsync("jmlexus", "Test$123", "Dealer", "jmlexus@ey.com", "+1 (123) 000-0001", new string[] { dealerRoleName });
                await CreateUserAsync("jmfamily", "Test$123", "Distributor", "jmfamily@ey.com", "+1 (123) 000-0001", new string[] { distributorRoleName });
