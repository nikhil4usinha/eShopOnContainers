...
using eShopAutomobile.ViewModels;
using eShopAutomobile.Helpers;
using eShopAutomobile.Authorization;
...
namespace eShopAutomobile
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.UseSqlServer(Configuration["ConnectionStrings:DefaultConnection"], b => b.MigrationsAssembly("eShopAutomobile"));
            ...
            {
                c.SwaggerDoc("v1", new Info { Title = "eShopAutomobile API", Version = "v1" });
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "eShopAutomobile API V1");
            });
