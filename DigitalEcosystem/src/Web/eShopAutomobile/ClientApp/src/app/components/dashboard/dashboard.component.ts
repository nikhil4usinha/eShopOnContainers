...
export class DashboardComponent implements OnInit {
  ...
  ngOnInit() {
     ...
     const optionsCompletedTasksChart: any = {
      ...
      var completedTasksChart2 = new Chartist.Line('#completedTasksChart2', dataCompletedTasksChart, optionsCompletedTasksChart);
      ...
      var websiteViewsChart2 = new Chartist.Bar('#websiteViewsChart2', datawebsiteViewsChart, optionswebsiteViewsChart, responsiveOptions);
