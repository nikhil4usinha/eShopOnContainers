...
$(function() {
    ...
    // Basic
    $('.bootpag-ey-default').bootpag({
        total: 20,
        maxVisible: 6,
        leaps: false
        }).on("page", function(event, num){
            $(".content-ey-default").html("Page " + num); // or some ajax content loading...
    ...
    // Basic
    $('.twbs-ey-default').twbsPagination({
        totalPages: 35,
        visiblePages: 4,
        prev: 'Prev',
        first: null,
        ...
        onPageClick: function (event, page) {
            $('.twbs-content-ey-default').text('Page ' + page);
        }
    });
    ...
    // Basic
    $('.datepaginator-ey-default').datepaginator({
        itemWidth: 70,
        navItemWidth: 28
    });
