...
$(function() {
    ...
    // Strength meter
    var feedback = [
        {color: '#f04c3e', text: 'Weak', textColor: '#fff'},
        {color: '#336699', text: 'Normal', textColor: '#fff'},
        {color: '#00a3ae', text: 'Good', textColor: '#fff'},
        {color: '#2c973e', text: 'Strong', textColor: '#fff'}
    ];
    ...
    $('.maxlength-custom').maxlength({
        threshold: 10,
        warningClass: "label label-ey-primary",
        limitReachedClass: "label label-ey-danger"
    });
    ...
    $('.maxlength-options').maxlength({
        alwaysShow: true,
        threshold: 10,
        warningClass: "text-ey-green",
        limitReachedClass: "text-ey-red",
        separator: ' of ',
        preText: 'You have ',
