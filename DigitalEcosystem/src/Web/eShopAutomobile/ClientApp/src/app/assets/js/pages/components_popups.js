...
$(function() {
	...
	$('[data-popup=tooltip-custom]').tooltip({
		template: '<div class="tooltip"><div class="bg-ey-yellow"><div class="tooltip-arrow"></div><div class="tooltip-inner"></div></div></div>'
	});
	...
	$('[data-popup=popover-custom]').popover({
		template: '<div class="popover border-ey-green"><div class="arrow"></div><h3 class="popover-title bg-ey-yellow"></h3><div class="popover-content"></div></div>'
	});
