...
$(function() {
    ...
    $('.wysihtml5-ey-default').wysihtml5({
    ...
    $('.wysihtml5-init').on('click', function() {
        ...
        $('.wysihtml5-events').wysihtml5({
            ...
            events: {
                load: function() { 
                    $.jGrowl('Editor has been loaded.', { theme: 'bg-ey-grey', header: 'WYSIHTML5 loaded' });
                },
                change_view: function() {
                    $.jGrowl('Editor view mode has been changed.', { theme: 'bg-ey-grey', header: 'View mode' });
                }
            }
        });
    });
