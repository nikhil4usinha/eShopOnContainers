...
$(function() {
    ...
    // Default style
    $('#pnotify-ey-default').on('click', function () {
        new PNotify({
            title: 'Primary notice',
            text: 'Check me out! I\'m a notice.',
            icon: 'icon-ey-warning22'
        });
    });
    ...
    $('#pnotify-styled-right').on('click', function () {
        new PNotify({
            title: 'Right icon',
            text: 'Check me out! I\'m a notice.',
            addclass: 'alert alert-ey-warning alert-styled-right',
            type: 'error'
        });
    });
    ...
    $('#pnotify-custom-styled').on('click', function () {
        new PNotify({
            ...
            text: 'Check me out! I\'m a notice.',
            addclass: 'alert alert-styled-left alert-styled-custom alert-arrow-left bg-ey-blue-50 text-ey-green'
        });
    });
    ...
    // Danger notification
    $('#pnotify-ey-danger').on('click', function () {
        new PNotify({
            title: 'Danger notice',
            text: 'Check me out! I\'m a notice.',
            icon: 'icon-blocked',
    ...
    $('#pnotify-ey-success').on('click', function () {
        new PNotify({
    ...
    // Info notification
    $('#pnotify-ey-info').on('click', function () {
        new PNotify({
            title: 'Info notice',
            text: 'Check me out! I\'m a notice.',
            icon: 'icon-ey-info22',
    ...
    // Solid primary
    $('#pnotify-solid-ey-primary').on('click', function () {
        new PNotify({
            title: 'Primary notice',
            text: 'Check me out! I\'m a notice.',
    ...
    // Solid danger
    $('#pnotify-solid-ey-danger').on('click', function () {
        new PNotify({
            title: 'Danger notice',
            text: 'Check me out! I\'m a notice.',
            addclass: 'bg-ey-danger'
        });
    });

    // Solid success
    $('#pnotify-solid-ey-success').on('click', function () {
        new PNotify({
            title: 'Success notice',
            text: 'Check me out! I\'m a notice.',
            addclass: 'bg-ey-green'
        });
    });

    // Solid warning
    $('#pnotify-solid-ey-warning').on('click', function () {
        new PNotify({
    ...
    // Solid info
    $('#pnotify-solid-ey-info').on('click', function () {
        new PNotify({
            title: 'Info notice',
            text: 'Check me out! I\'m a notice.',
            addclass: 'bg-ey-info'
    ...
    $('#pnotify-solid-styled-left').on('click', function () {
        new PNotify({
            title: 'Left icon',
            text: 'Check me out! I\'m a notice.',
            addclass: 'alert bg-ey-grey-alt alert-styled-left'
        });
    });
    ...
    $('#pnotify-solid-styled-right').on('click', function () {
        new PNotify({
            title: 'Right icon',
            text: 'Check me out! I\'m a notice.',
            addclass: 'alert bg-ey-danger alert-styled-right',
            type: 'error'
        });
    });
    ...
    // Default
    $('#pnotify-desktop-ey-default').on('click', function () {
    ...
    // Danger
    $('#pnotify-desktop-ey-danger').on('click', function () {
        PNotify.desktop.permission();
        (new PNotify({
    ...
    // Success
    $('#pnotify-desktop-ey-success').on('click', function () {
        PNotify.desktop.permission();
        (new PNotify({
    ...
    // Warning
    $('#pnotify-desktop-ey-warning').on('click', function () {
        PNotify.desktop.permission();
        (new PNotify({
    ...
    // Info
    $('#pnotify-desktop-ey-info').on('click', function () {
        PNotify.desktop.permission();
        (new PNotify({
        ...
        var notice = new PNotify({
            ...
            confirm: {
                ...
                buttons: [
                    {
                        text: 'Yes',
                        addClass: 'btn btn-sm btn-ey-primary'
                    },
                    {
        ...
        new PNotify({
            ...
            confirm: {
                ...
                buttons: [
                    {
                        text: 'Fries',
                        addClass: 'btn btn-sm bg-ey-grey-alt',
                    ...
                    },
                    {
                        ...
                        addClass: 'btn btn-sm bg-ey-danger',
                        click: function(notice) {
                            notice.update({
                                title: 'You\'ve chosen a side',
                    ...
                    {
                        text: 'Fruit',
                        addClass: 'btn btn-sm bg-ey-purple',
                        click: function(notice) {
                            notice.update({
                                title: 'You\'ve chosen a side',
                                text: 'You want fruit.',
    ...
    $('#pnotify-switching').on('click', function () {
        new PNotify({
            ...
            addclass: 'alert bg-ey-grey-alt alert-styled-right',
                ...
                PNotify.update({
                    ...
                    before_close: function(PNotify) {
                        PNotify.update({
                            ...
                            addclass: 'alert bg-ey-green alert-styled-right',
                            type: 'success',
                            before_close: function(PNotify) {
                                PNotify.update({
                                    title: 'Info',
                                    text: 'Everything\'s cool now.',
                                    addclass: 'alert bg-ey-info alert-styled-right',
                                    type: 'info',
                                    before_close: null
                                });
                                PNotify.queueRemove();
    ...
    $('#pnotify-progress').on('click', function () {
        ...
        var loader = new PNotify({
            ...
            <div class="progress-bar bg-ey-danger" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100" style="width: 0">\
    ...
    function show_stack_top_left(type) {
        var opts = {
            ...
            addclass: "stack-top-left bg-ey-grey-alt",
        ...
        switch (type) {
            ...
            opts.addclass = "stack-top-left bg-ey-danger";
            opts.type = "error";
            break;
            ...
            opts.addclass = "stack-top-left bg-ey-info";
            opts.type = "info";
            break;
            ...
            opts.addclass = "stack-top-left bg-ey-green";
            opts.type = "success";
            break;
        }
        new PNotify(opts);
    ...
    function show_stack_bottom_left(type) {
        var opts = {
            title: "Over here",
            text: "Check me out. I'm in a different stack.",
            addclass: "stack-bottom-left bg-ey-grey-alt",
        ...
        switch (type) {
            ...
            opts.title = "Oh No";
            opts.text = "Watch out for that water tower!";
            opts.addclass = "stack-bottom-left bg-ey-danger";
            opts.type = "error";
            break;
            ...
            opts.title = "Breaking News";
            opts.text = "Have you met Ted?";
            opts.addclass = "stack-bottom-left bg-ey-info";
            opts.type = "info";
            break;
            ...
            opts.title = "Good News Everyone";
            opts.text = "I've invented a device that bites shiny metal asses.";
            opts.addclass = "stack-bottom-left bg-ey-green";
            opts.type = "success";
            break;
        }
        new PNotify(opts);
    ...
    function show_stack_bottom_right(type) {
        var opts = {
            title: "Over here",
            text: "Check me out. I'm in a different stack.",
            addclass: "stack-bottom-right bg-ey-grey-alt",
        ...
        switch (type) {
            ...
            opts.title = "Oh No";
            opts.text = "Watch out for that water tower!";
            opts.addclass = "stack-bottom-right bg-ey-danger";
            opts.type = "error";
            break;
            ...
            opts.title = "Breaking News";
            opts.text = "Have you met Ted?";
            opts.addclass = "stack-bottom-right bg-ey-info";
            opts.type = "info";
            break;
            ...
            opts.title = "Good News Everyone";
            opts.text = "I've invented a device that bites shiny metal asses.";
            opts.addclass = "stack-bottom-right bg-ey-green";
            opts.type = "success";
            break;
        }
        new PNotify(opts);
    ...
    function show_stack_custom_left(type) {
        var opts = {
            title: "Over here",
            text: "Check me out. I'm in a different stack.",
            addclass: "stack-custom-left bg-ey-grey-alt alert-styled-right",
        ...
        switch (type) {
            ...
            opts.title = "Oh No";
            opts.text = "Watch out for that water tower!";
            opts.addclass = "stack-custom-left bg-ey-danger";
            opts.type = "error";
            break;
            ...
            opts.title = "Breaking News";
            opts.text = "Have you met Ted?";
            opts.addclass = "stack-custom-left bg-ey-info";
            opts.type = "info";
            break;
            ...
            opts.title = "Good News Everyone";
            opts.text = "I've invented a device that bites shiny metal asses.";
            opts.addclass = "stack-custom-left bg-ey-green";
            opts.type = "success";
            break;
        }
        new PNotify(opts);
    ...
    function show_stack_custom_right(type) {
        var opts = {
            title: "Over here",
            text: "Check me out. I'm in a different stack.",
            addclass: "stack-custom-right bg-ey-grey-alt",
        ...
        switch (type) {
            ...
            opts.title = "Oh No";
            opts.text = "Watch out for that water tower!";
            opts.addclass = "stack-custom-right bg-ey-danger";
            opts.type = "error";
            break;
            ...
            opts.title = "Breaking News";
            opts.text = "Have you met Ted?";
            opts.addclass = "stack-custom-right bg-ey-info";
            opts.type = "info";
            break;
            ...
            opts.title = "Good News Everyone";
            opts.text = "I've invented a device that bites shiny metal asses.";
            opts.addclass = "stack-custom-right bg-ey-green";
            opts.type = "success";
            break;
        }
        new PNotify(opts);
    ...
    function show_stack_custom_top(type) {
        var opts = {
            ...
            addclass: "stack-custom-top bg-ey-grey-alt",
        ...
        switch (type) {
            ...
            opts.title = "Oh No";
            opts.text = "Watch out for that water tower!";
            opts.addclass = "stack-custom-top bg-ey-danger";
            opts.type = "error";
            break;
            ...
            opts.title = "Breaking News";
            opts.text = "Have you met Ted?";
            opts.addclass = "stack-custom-top bg-ey-info";
            opts.type = "info";
            break;
            ...
            opts.title = "Good News Everyone";
            opts.text = "I've invented a device that bites shiny metal asses.";
            opts.addclass = "stack-custom-top bg-ey-green";
            opts.type = "success";
            break;
        }
        new PNotify(opts);
    ...
    function show_stack_custom_bottom(type) {
        var opts = {
            ...
            width: "100%",
            cornerclass: "no-border-radius",
            addclass: "stack-custom-bottom bg-ey-grey-alt",
        ...
        switch (type) {
            ...
            opts.title = "Oh No";
            opts.text = "Watch out for that water tower!";
            opts.addclass = "stack-custom-bottom bg-ey-danger";
            opts.type = "error";
            break;
            ...
            opts.title = "Breaking News";
            opts.text = "Have you met Ted?";
            opts.addclass = "stack-custom-bottom bg-ey-info";
            opts.type = "info";
            break;
            ...
            opts.title = "Good News Everyone";
            opts.text = "I've invented a device that bites shiny metal asses.";
            opts.addclass = "stack-custom-bottom bg-ey-green";
            opts.type = "success";
            break;
        }
        new PNotify(opts);
