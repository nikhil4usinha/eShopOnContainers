...
$(function() {
    ...
    // Start
    $('#h-ey-default-basic-start').click(function() {
        var $pb = $('#h-ey-default-basic .progress-bar');
        $pb.attr('data-transitiongoal', $pb.attr('data-transitiongoal-backup'));
        $pb.progressbar();
    });

    // Reset
    $('#h-ey-default-basic-reset').click(function() {
        $('#h-ey-default-basic .progress-bar').attr('data-transitiongoal', 0).progressbar();
    });
    ...
    // Start
    $('#v-ey-default-basic-start').click(function() {
        $('#v-ey-default-basic .progress-bar').each(function () {
            var $pb = $(this);
            $pb.attr('data-transitiongoal', $pb.attr('data-transitiongoal-backup'));
            $pb.progressbar();
        });
    ...
    // Reset
    $('#v-ey-default-basic-reset').click(function() {
        $('#v-ey-default-basic .progress-bar').attr('data-transitiongoal', 0).progressbar();
    });
