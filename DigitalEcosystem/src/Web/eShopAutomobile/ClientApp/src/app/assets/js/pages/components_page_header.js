...
$(function() {
    ...
    $('#reportrange').daterangepicker(
        {
            ...
            opens: 'left',
            buttonClasses: ['btn'],
            applyClass: 'btn-small btn-ey-info btn-block',
    ...
    $('.daterange-ranges').daterangepicker(
        {
            ...
            opens: 'left',
            applyClass: 'btn-small btn-ey-primary btn-block',
            cancelClass: 'btn-small bg-ey-primary btn-block'
            //format: 'MM/DD/YYYY'
        },
        function(start, end) {
    ...
    $('.multiselect').multiselect({
        dropRight: true,
        buttonClass: 'btn btn-ey-default'
    });
    ...
    // Styled file input
    $(".file-styled").uniform({
        fileButtonClass: 'action btn bg-ey-danger btn-icon',
