...
$(function() {
    ...
    $(".draggable-element").draggable({
        containment: "#draggable-ey-default-container"
    });
    ...
    $("#droppable-basic-target").droppable({
        drop: function(event, ui) {
            $(this).addClass("bg-ey-green border-ey-green text-white").html("<span>Dropped!</span>");
        }
    });
    ...
    $("#droppable-visual-target-active").droppable({
        ...
        activeClass: "bg-ey-grey border-ey-primary text-white",
        drop: function(event, ui) {
            $(this).addClass("bg-ey-green border-ey-green text-white").html("<span>Dropped!</span>");
        }
    });
    ...
    $("#droppable-visual-target-hover").droppable({
        containment: '#droppable-visual-container',
        hoverClass: "bg-ey-grey-alt border-ey-blue text-white",
        drop: function(event, ui) {
            $(this).addClass("bg-ey-yellow border-ey-green text-white").html("<span>Dropped!</span>");
        }
    });
