                ...
                series: [
                    {
                        ...
                        markPoint: {
                            data: [
                                ...
                                {type: 'max', name: 'Maximum', symbol: 'emptyCircle', itemStyle: {normal: {color: '#00a3ae',label: {position: 'top'}}}},
                                {type: 'min', name: 'Minimum', symbol: 'emptyCircle', itemStyle: {normal: {color: '#00a3ae',label: {position: 'top'}}}},
                        ...
                        markLine: {
                            data: [
                                ...
                                // Default vertical axis
                                {type: 'max', name: 'Maximum', itemStyle: {normal: {color: '#00a3ae'}}},
                                {type: 'min', name: 'Minimum', itemStyle: {normal: {color: '#00a3ae'}}},
                                {type: 'average', name: 'Average', itemStyle: {normal: {color: '#00a3ae'}}},
