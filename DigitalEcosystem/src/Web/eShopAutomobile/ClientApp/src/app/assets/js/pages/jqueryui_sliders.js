...
$(function() {
    ...
    // Basic
    $(".ui-slider-vertical-ey-default > span").each(function() {
    ...
    // Default handle
    $(".ui-slider-vertical-handle-ey-default > span").each(function() {
    ...
    $(".ui-slider-labels-custom").on("slidechange", function(e,ui) {
        $("#ui-slider-labels-custom-output").html("You selected " + "<span class='text-ey-red'>" + months[ui.value] + "</span>");
    });
