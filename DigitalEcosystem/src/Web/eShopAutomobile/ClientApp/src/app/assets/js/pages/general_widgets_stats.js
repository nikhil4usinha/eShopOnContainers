...
$(function() {
    ...
    // Initialize chart
    areaChartWidget("#chart_area_basic", 50, '#91278F');
    ...
    // Initialize charts
    barChartWidget("#chart_bar_basic", 24, 50, true, "elastic", 1200, 50, "#646464", "members");
    ...
    // Initialize chart
    lineChartWidget('#line_chart_simple', 50, '#333333', 'rgba(33,150,243,0.5)', '#333333', '#fff');
    ...
    // Initialize chart
    sparklinesWidget("#sparklines_basic", "area", 30, 50, "basis", 750, 2000, "#808080");
    ...
    // Initialize charts
    progressIcon('#progress_icon_one', 42, 2.5, "#eee", "#646464", 0.68, "icon-heart6");
    progressIcon('#progress_icon_two', 42, 2.5, "#eee", "#91278F", 0.82, "icon-trophy3");
    ...
    // Initialize charts
    progressPercentage('#progress_percentage_one', 46, 3, "#eee", "#333333", 0.79);
    progressPercentage('#progress_percentage_two', 46, 3, "#eee", "#646464", 0.62);
    ...
    // Initialize chart
    roundedProgressSingle("#rounded_progress_single", 150, 700, '#00a3ae');
    ...
    function roundedProgressMultiple(element, size) {
        ...
        // Colors
        var colors = ['#78909C', '#00a3ae', '#00A3AE'];
