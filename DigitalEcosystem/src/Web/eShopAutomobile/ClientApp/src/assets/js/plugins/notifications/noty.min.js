    ...
    style   : function() {
        ...
        switch(this.options.type) {
            ...
            case 'notification':
                ...
                break;
            case 'warning':
                this.$bar.css({backgroundColor: '#00a3ae', color: '#fff'});
                this.$buttons.css({});
                break;
            case 'error':
                this.$bar.css({backgroundColor: '#f04c3e', color: '#fff'});
                this.$message.css({});
                this.$buttons.css({});
                break;
            case 'information':
                this.$bar.css({backgroundColor: '#ac98db', color: '#fff'});
                this.$buttons.css({});
                break;
            case 'success':
                this.$bar.css({backgroundColor: '#2C973E', color: '#fff'});
                this.$buttons.css({});
                break;
            default:
