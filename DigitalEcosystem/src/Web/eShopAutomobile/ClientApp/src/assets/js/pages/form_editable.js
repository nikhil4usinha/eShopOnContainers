...
$(function() {
    ...
    $.fn.editableform.buttons = 
        '<button type="submit" class="btn bg-ey-green btn-icon editable-submit"><i class="icon-check"></i></button>' +
        '<button type="button" class="btn bg-ey-red btn-icon editable-cancel"><i class="icon-x"></i></button>';
    ...
    $('#button-variation').on('shown', function(e, editable) {
        editable.input.$input.parents('.editable-input').parent().find('.editable-submit').removeClass('btn-ey-success').addClass('btn-ey-danger');
        editable.input.$input.parents('.editable-input').parent().find('.editable-cancel').removeClass('btn-ey-danger').addClass('btn-ey-success');
    });
    ...
    $('#input-group-button').on('shown', function (e, editable) {
        editable.input.$input.wrap('<div class="input-group"></div>');
        $('<div class="input-group-btn"><button type="button" class="btn btn-ey-default">Button</button></div>').insertBefore(editable.input.$input);
    });
    ...
    $('#input-group-dropdown').on('shown', function (e, editable) {
        editable.input.$input.wrap('<div class="input-group"></div>');
        $('<div class="input-group-btn"><button type="button" class="btn btn-ey-default btn-icon" data-toggle="dropdown"><i class="icon-cog5"></i> <span class="caret"></span></button> <ul class="dropdown-menu"> <li><a href="#">Action</a></li> <li><a href="#">Another action</a></li> <li><a href="#">Something else here</a></li> </ul> </div>').insertBefore(editable.input.$input);
    });
    ...
    // Initialize
    $('#select-ey-default-remote').editable({
        source: '/remote',
        showbuttons: false 
    });
    ...
    // Initialize
    $('#select-ey-default-error').editable({
        source: '/error'
    });
    ...
    $('#input-tags-labels').editable({
        ...
        display: function(value) {
            ...
            $(this).each(function() { 
                var text = $(this).text().split(',');
                for( var i = 0, len = text.length; i < len; i++ ) { 
                    text[i] = '<span class="label label-ey-primary">' + text[i] + '</span>'; 
                } 
                $(this).html(text.join(' '));
            });
        }
    ...
    function movieFormatResult(movie) {
        ...
        markup += "<td class='movie-ey-info'><div class='movie-title'>" + movie.title + "</div>";
