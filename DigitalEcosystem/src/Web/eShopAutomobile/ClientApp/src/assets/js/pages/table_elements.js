...
$(function() {
    ...
    $.fn.editableform.buttons = 
        '<button type="submit" class="btn bg-ey-yellow btn-icon editable-submit"><i class="icon-check"></i></button>' +
        '<button type="button" class="btn btn-ey-default btn-icon editable-cancel"><i class="icon-x"></i></button>';
    ...
    $('.styled, .multiselect-container input').uniform({
        radioClass: 'choice',
        wrapperClass: 'border-ey-grey-alt text-ey-primary'
    });


    // Styled file input
    $('.file-styled').uniform({
        fileButtonClass: 'action btn bg-ey-danger'
    });
