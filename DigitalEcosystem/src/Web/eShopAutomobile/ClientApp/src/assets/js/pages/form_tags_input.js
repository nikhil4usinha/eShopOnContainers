...
$(function() {
    ...
    // Add class on init
    $('.tokenfield-ey-primary').on('tokenfield:initialize', function (e) {
        $(this).parent().find('.token').addClass('bg-ey-grey-alt')
    });

    // Initialize plugin
    $('.tokenfield-ey-primary').tokenfield();

    // Add class when token is created
    $('.tokenfield-ey-primary').on('tokenfield:createdtoken', function (e) {
        $(e.relatedTarget).addClass('bg-ey-grey-alt')
    });
    ...
    // Add class on init
    $('.tokenfield-ey-blue-50').on('tokenfield:initialize', function (e) {
        $(this).parent().find('.token').addClass('bg-ey-yellow')
    });

    // Initialize plugin
    $('.tokenfield-ey-blue-50').tokenfield();

    // Add class when token is created
    $('.tokenfield-ey-blue-50').on('tokenfield:createdtoken', function (e) {
        $(e.relatedTarget).addClass('bg-ey-yellow')
    });
    ...
    // Add class on init
    $('.tokenfield-ey-purple').on('tokenfield:initialize', function (e) {
        $(this).parent().find('.token').addClass('bg-ey-red')
    });

    // Initialize plugin
    $('.tokenfield-ey-purple').tokenfield();

    // Add class when token is created
    $('.tokenfield-ey-purple').on('tokenfield:createdtoken', function (e) {
        $(e.relatedTarget).addClass('bg-ey-red')
    });
    ...
    // Add class on init
    $('.tokenfield-ey-success').on('tokenfield:initialize', function (e) {
        $(this).parent().find('.token').addClass('bg-ey-green')
    });

    // Initialize plugin
    $('.tokenfield-ey-success').tokenfield();

    // Add class when token is created
    $('.tokenfield-ey-success').on('tokenfield:createdtoken', function (e) {
        $(e.relatedTarget).addClass('bg-ey-green')
    });
    ...
    // Add class on init
    $('.tokenfield-ey-danger').on('tokenfield:initialize', function (e) {
        $(this).parent().find('.token').addClass('bg-ey-danger')
    });

    // Initialize plugin
    $('.tokenfield-ey-danger').tokenfield();

    // Add class when token is created
    $('.tokenfield-ey-danger').on('tokenfield:createdtoken', function (e) {
        $(e.relatedTarget).addClass('bg-ey-danger')
    });
    ...
    // Add class on init
    $('.tokenfield-ey-warning').on('tokenfield:initialize', function (e) {
        $(this).parent().find('.token').addClass('bg-ey-warning')
    });

    // Initialize plugin
    $('.tokenfield-ey-warning').tokenfield();

    // Add class when token is created
    $('.tokenfield-ey-warning').on('tokenfield:createdtoken', function (e) {
        $(e.relatedTarget).addClass('bg-ey-warning')
    });
    ...
    elt2.tagsinput({
        tagClass: function(item) {
            switch (item.continent) {
                case 'Europe'   : return 'label bg-ey-purple';
                case 'America'  : return 'label bg-ey-danger';
                case 'Australia': return 'label bg-ey-green';
                case 'Africa'   : return 'label bg-ey-grey-alt';
                case 'Asia'     : return 'label bg-ey-danger';
            }
        },
        itemValue: 'value',
        itemText: 'text',
