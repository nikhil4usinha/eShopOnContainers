...
$(function () {
    ...
    var pie_chart = c3.generate({
        ...
        size: { width: 350 },
        color: {
            pattern: ['#3F51B5', '#FF9800', '#2C973E', '#ac98db', '#f04c3e']
        },
        data: {
            columns: [
                ['data1', 30],
    ...
    var bar_stacked_chart = c3.generate({
        ...
        size: { height: 400 },
        color: {
            pattern: ['#FF9800', '#f04c3e', '#009688', '#2C973E']
        },
        data: {
            columns: [
    ...
    var combined_chart = c3.generate({
        ...
        size: { height: 400 },
        color: {
            pattern: ['#FF9800', '#f04c3e', '#009688', '#2C973E', '#646464', '#8BC34A']
        },
        data: {
            columns: [
