                ...
                series: [
                    {
                        ...
                        markPoint: {
                            data: [
                                ...
                                // Vertical
                                {type: 'max', name: 'Maximum',symbol: 'emptyCircle', itemStyle: {normal: {color: '#f04c3e',label: {position: 'top'}}}},
                                {type: 'min', name: 'Minimum',symbol: 'emptyCircle', itemStyle: {normal: {color: '#f04c3e',label: {position: 'bottom'}}}},
                        ...
                        markLine: {
                            data: [
                                ...
                                // Vertical
                                {type: 'max', name: 'Maximum', itemStyle: {normal: {color: '#f04c3e'}}},
                                {type: 'min', name: 'Minimum', itemStyle: {normal: {color: '#f04c3e'}}},
                                {type: 'average', name: 'Average', itemStyle: {normal: {color: '#f04c3e'}}},
