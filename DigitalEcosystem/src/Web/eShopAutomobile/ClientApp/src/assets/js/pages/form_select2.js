...
$(function() {
    ...
    $('.select-results-color').select2({
        containerCssClass: 'bg-ey-yellow'
    });


    // Custom menu color
    $('.select-menu-color').select2({
        dropdownCssClass: 'bg-ey-yellow'
    });


    // Custom menu and results color
    $('.select-custom-colors').select2({
        containerCssClass: 'bg-ey-purple',
        dropdownCssClass: 'bg-ey-purple'
    });
    ...
    $('.select-border-color').select2({
        dropdownCssClass: 'border-ey-grey-alt',
        containerCssClass: 'border-ey-grey-alt text-ey-primary'
    });
