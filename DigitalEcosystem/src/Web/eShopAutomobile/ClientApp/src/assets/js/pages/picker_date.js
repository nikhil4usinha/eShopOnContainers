...
$(function() {
    ...
    $('.daterange-basic').daterangepicker({
        applyClass: 'bg-ey-grey',
        cancelClass: 'bg-ey-primary'
    });
    ...
    $('.daterange-buttons').daterangepicker({
        applyClass: 'btn-ey-success',
        cancelClass: 'btn-ey-danger'
    });
    ...
    $('.daterange-predefined').daterangepicker(
        {
            ...
            opens: 'left',
            applyClass: 'btn-small bg-ey-grey',
            cancelClass: 'btn-small bg-ey-primary'
        },
        function(start, end) {
            $('.daterange-predefined span').html(start.format('MMMM D, YYYY') + ' &nbsp; - &nbsp; ' + end.format('MMMM D, YYYY'));
            $.jGrowl('Date range has been changed', { header: 'Update', theme: 'bg-ey-grey-alt', position: 'center', life: 1500 });
        }
    );
