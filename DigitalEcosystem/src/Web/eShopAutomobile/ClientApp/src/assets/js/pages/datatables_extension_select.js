...
$(function() {
    ...
    $('.datatable-select-buttons').DataTable({
        ...
        buttons: [
            {extend: 'selected', className: 'btn btn-ey-default'},
            {extend: 'selectedSingle', className: 'btn btn-ey-default'},
            {extend: 'selectAll', className: 'btn bg-ey-grey-alt'},
            {extend: 'selectNone', className: 'btn bg-ey-grey-alt'},
            {extend: 'selectRows', className: 'btn bg-ey-yellow'},
            {extend: 'selectColumns', className: 'btn bg-ey-yellow'},
            {extend: 'selectCells', className: 'btn bg-ey-yellow'}
        ],
        select: true
    });
