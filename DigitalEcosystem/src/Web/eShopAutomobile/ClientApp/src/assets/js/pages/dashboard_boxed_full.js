...
$(function() {    
    ...
    switches.forEach(function(html) {
        var switchery = new Switchery(html, {color: '#2C973E'});
    });
    ...
    $('.daterange-ranges').daterangepicker(
        {
            ...
            opens: 'left',
            applyClass: 'btn-small bg-ey-grey btn-block',
            cancelClass: 'btn-small bg-ey-primary btn-block',
            format: 'MM/DD/YYYY'
        },
        function(start, end) {
    ...
    function trafficSources(element, height) {
        ...
        // Colors
        var colorrange = ['#333333', '#646464', '#808080', '#999999', '#C0C0C0', '#F0F0F0'];
    ...
    function appSalesLines(element, height) {
        ...
        // Line colors
        var scale = ["#2C973E", "#00a3ae", "#91278F"],
        ...
        var menu = $("#select_date").multiselect({
            ...
            buttonText: function (options, element) {
                ...
                return '<span class="status-mark border-ey-blue position-left"></span>' + selected.substr(0, selected.length -2);
            }
        });
    ...
    monthlySalesArea("#monthly-sales-stats", 100, '#00A3AE'); // initialize chart
    ...
    messagesArea("#messages-stats", 40, '#91278F'); // initialize chart
    ...
    // Initialize chart
    sparkline("#new-visitors", "line", 30, 35, "basis", 750, 2000, "#2C973E");
    sparkline("#new-sessions", "line", 30, 35, "basis", 750, 2000, "#FFE600");
    sparkline("#total-online", "line", 30, 35, "basis", 750, 2000, "#91278F");
    ...
    // Initialize chart
    progressMeter("#today-progress", 20, 20, '#ac98db');
    progressMeter("#yesterday-progress", 20, 20, '#ac98db');
        ...
        var data = [
            {
                ...
                "icon": "<span class='status-mark border-ey-blue-50 position-left'></span>",
                "value": 439,
                "color": "#FFE600"
            }, {
                "status": "Closed campaigns",
                "icon": "<span class='status-mark border-ey-danger position-left'></span>",
                "value": 290,
                "color": "#646464"
            }, {
                "status": "Pending campaigns",
                "icon": "<span class='status-mark border-ey-green position-left'></span>",
                "value": 190,
                "color": "#808080"
            }, {
                "status": "Campaigns on hold",
                "icon": "<span class='status-mark border-ey-grey position-left'></span>",
                "value": 148,
                "color": "#999999"
            }
        ];
        ...
        var data = [
            {
                ...
                "icon": "<i class='status-mark border-ey-blue-50 position-left'></i>",
                "value": 295,
                "color": "#FFE600"
            }, {
                "status": "Resolved tickets",
                "icon": "<i class='status-mark border-ey-green position-left'></i>",
                "value": 189,
                "color": "#808080"
            }, {
                "status": "Closed tickets",
                "icon": "<i class='status-mark border-ey-danger position-left'></i>",
                "value": 277,
                "color": "#646464"
            }
        ];
    ...
    // Initialize charts
    generateBarChart("#hours-available-bars", 24, 40, true, "elastic", 1200, 50, "#FFE600", "hours");
    generateBarChart("#goal-bars", 24, 40, true, "elastic", 1200, 50, "#333333", "goal");
    ...
    // Initialize charts
    progressCounter('#hours-available-progress', 38, 2, "#FFE600", 0.68, "icon-watch text-ey-grey", 'Hours available', '64% average')
    progressCounter('#goal-progress', 38, 2, "#333333", 0.82, "icon-trophy3 text-ey-grey", 'Productivity goal', '87% average')
