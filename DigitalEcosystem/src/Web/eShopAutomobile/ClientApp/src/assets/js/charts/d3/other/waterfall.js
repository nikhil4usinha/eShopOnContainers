...
$(function () {
    ...
    function waterfall(element, height) {
        ...
        d3.csv("assets/demo_data/d3/other/waterfall.csv", function(error, data) {
            ...
            // Apply colors
            bar.filter(function(d) { return d.class == "positive" }).select('rect').style("fill", "#646464");
            bar.filter(function(d) { return d.class == "negative" }).select('rect').style("fill", "#808080");
