...
$(function() {
    ...
    $('.multiselect-menu-bg-color').multiselect({
        templates: {
            ul: '<ul class="multiselect-container bg-ey-yellow dropdown-menu"></ul>'
        }
    });
    ...
    $('.multiselect-combine-all').multiselect({
        buttonClass: 'btn bg-ey-grey',
        templates: {
            ul: '<ul class="multiselect-container bg-ey-grey dropdown-menu"></ul>'
        }
    });
    ...
    // Primary
    $('.multiselect-ey-primary').multiselect({
        buttonClass: 'btn bg-ey-yellow'
    });

    // Danger
    $('.multiselect-ey-danger').multiselect({
        buttonClass: 'btn btn-ey-danger'
    });

    // Success
    $('.multiselect-ey-success').multiselect({
        buttonClass: 'btn btn-ey-success'
    });

    // Warning
    $('.multiselect-ey-warning').multiselect({
        buttonClass: 'btn btn-ey-warning'
    });

    // Info
    $('.multiselect-ey-info').multiselect({
        buttonClass: 'btn bg-ey-yellow'
    });
    ...
    $('.multiselect-lg').multiselect({
        buttonClass: 'btn btn-ey-default btn-lg'
    });

    // Small
    $('.multiselect-sm').multiselect({
        buttonClass: 'btn btn-ey-default btn-sm'
    });

    // Mini
    $('.multiselect-xs').multiselect({
        buttonClass: 'btn btn-ey-default btn-xs'
    });
    ...
    $('.multiselect-onchange-notice').multiselect({
        ...
        onChange: function(element, checked){
            ...
            new PNotify({
                ...
                addclass: 'bg-ey-yellow alert-styled-left'
            });
        }
    });
    ...
    $('.multiselect-show-values').on('click', function() {
        $('.values-area').text('Selected: ' + $('.multiselect-display-values').val().join(', ')).addClass('alert alert-ey-info');
    });
